...
#pragma warning restore 618
        ...
        private static List<RenderTask> ListRenderTasks(WotContext context, Style style, bool all = false)
        {
            ...
            switch (all ? DisplayFilter.All : App.Settings.DisplayFilter)
            {
                ...
                case DisplayFilter.Italy: selection = context.Tanks.Where(t => t.Country == Country.Italy); break;
                ...
                case DisplayFilter.Intunion: selection = context.Tanks.Where(t => t.Country == Country.Intunion); break;
