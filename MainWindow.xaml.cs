    ...
    partial class MainWindow : ManagedWindow
    {
        ...
        private void UpdateIcons(object _ = null, EventArgs __ = null)
        {
            ...
            for (int i = 0; i < renderTasks.Count; i++)
            {
                ...
                {
                    image.Source = _renderResults[renderTask.TankSystemId].Image.UnderlyingImage;
                    ...
                    tasks.Add(() =>
                    {
                        try
                        {
                            ...
                            Dispatcher.Invoke(new Action(() =>
                            {
                                ...
                                image.Source = renderTask.Image.UnderlyingImage;
