...
namespace TankIconMaker.Layers
{
    ...
    {
        public override int Version { get { return 1; } }
        public override string TypeName { get { return "Image / Filename pattern"; } }
        public override string TypeDescription { get { return "Draws an arbitrary, user-supplied image, loaded from a file whose name is generated by substituting various tank properties into placeholders."; } }

        [Category("Image")]
        [Description("Filename pattern. Use the following placeholders: {tier}, {country}, {class}, {category}, {id}.")]
