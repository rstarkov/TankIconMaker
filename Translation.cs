...
namespace TankIconMaker
{
    ...
    partial class MainWindowTranslation
    {
        ...
        public TrString ErrorCreateAtlasImage = "Unable to place images in the atlas \"{0}\". Try reducing the size " +
    ...
    sealed class SelectorTranslation
    {
        ...
        public TrString CountryItaly = "Country: Italy";
        public TrString CountryIntunion = "Country: Union";
