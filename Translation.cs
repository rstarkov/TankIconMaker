...
namespace TankIconMaker
{
    ...
    sealed class LayerTranslation
    {
        ...
        public MemberDescriptionTr VisibleFor = new MemberDescriptionTr { DisplayName = "Visible for", Description = "Specifies for which types of tanks to show this layer." };
    }
    ...
    sealed class CustomImageLayerTranslation
    {
        ...
        public TrString LayerDescription = "Draws a user-supplied image.";
    ...
    sealed class FilenamePatternImageLayerTranslation
    {
        ...
        public TrString LayerDescription = "Draws a user-supplied image loaded from a file whose name is generated by substituting various tank properties into placeholders.";
