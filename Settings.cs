...
#pragma warning restore 0618
    ...
    enum DisplayFilter
    {
        All = 0,
        OneOfEach = 1,
        USSR = 3, Germany, USA, France, UK, China, Japan, Czech, Sweden, Poland,
        Light = 14, Medium, Heavy, Artillery, Destroyer,
        Normal = 20, Premium, Special,
        TierLow = 24, TierMedHigh, TierHigh,
    }
}
