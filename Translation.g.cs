...
namespace TankIconMaker
{
    ...
    sealed partial class MainWindowTranslation
    {
        ...
        [LingoAutoGenerated]
        public TrString ctStyleBulkSave = "Bulk _save";

        [LingoAutoGenerated]
        public TrString ctSaveFormatHelp = "Save format help";

        [LingoAutoGenerated]
        public TrString IconsetPath = "Save path (format is declared in Save as...-Save format help)";
        ...
        [LingoAutoGenerated]
        public TrString ctBrowseAndSaveIcons_Japan = "Only _Japan...";
