...
namespace TankIconMaker
{
    static class OldFiles
    {
        ...
        static oldFile[] _oldFiles = new[]
        {
            ...
            new oldFile("Data\\WotGameVersion-#0039.xml", 1843, "a50848e7fe90381a1ed228c09cfeed1643dd4aff7ff8154ad4df56ef0d0894be"),
        ...
        static string[] _currentFiles = new[]
        {
            ...
            "Images/tierA-09.png",
            "Images/tierA-10.png",
            "Licenses/license-FreeImage.txt",
            "Licenses/license-ICSharpCode.SharpZipLib.txt",
            "Licenses/license-Magick.NET.txt",
            "Licenses/license-NvidiaTextureTools.txt",
            "Licenses/license-Ookii.Dialogs.Wpf.txt",
            "Licenses/license-RT.Util.txt",
            "Licenses/license-TankIconMaker.txt",
            "Licenses/license-TeximpNet.txt",
            "Licenses/license-WpfCrutches.txt",
            "Licenses/license-WPFToolkit.Extended.txt",
            "Translations/TankIconMaker.de.xml",
            "Translations/TankIconMaker.ru.xml",
            "Translations/TankIconMaker.zh_cn.xml",
            "FreeImage32.dll",
            "FreeImage64.dll",
            "ICSharpCode.SharpZipLib.dll",
            "Magick.NET-AnyCPU.dll",
            "nvtt32.dll",
            "nvtt64.dll",
